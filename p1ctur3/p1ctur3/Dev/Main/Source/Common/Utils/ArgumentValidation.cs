...
namespace Telekad.Utils
{
    public static class ArgumentValidation
    {
        ...
        /// <summary>
        /// Checks the array is not null and then ensures the length of the array is at least minumunLength.
        /// </summary>
        /// <typeparam name="T">The type of the array being checked</typeparam>
        /// <param name="array">The array to be checked.</param>
        ...
        /// <param name="paramName">Name of the parameter being checked.</param>
        /// <exception cref="ArgumentException">Thrown if the object is the incorrect type.</exception>
        public static void CheckNullableArgumentIsCorrectType(object param, Type desiredType, string paramName)
        {
            if (param == null)
                return;
        ...
        /// <summary>
        /// Checks the argument is strictly less than
        /// </summary>
        /// <param name="arg">The arg to be checked.</param>
        /// <param name="maxValue">The value that must be strictly greater than <paramref name="arg"/></param>
        /// <param name="argumentName">Name of the argument being checked.</param>
        /// <exception cref="ArgumentOutOfRangeException">thrown if <paramref name="maxValue"/> &lt; <paramref name="arg"/></exception>
        ...
        {
            if(arg == null || arg.CompareTo(minValue) < 0 || arg.CompareTo(maxValue) > 1 )
                throw new ArgumentOutOfRangeException(argumentName);
        }
