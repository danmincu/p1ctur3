...
namespace Telekad.Ux
{
    public class NotifyObject : INotifyPropertyChanged
    {
        ...
        {
            ArgumentValidation.CheckArgumentForNull(changedAction, "changedAction");
        ...
        {
            string commandName = canExecuteName.StripLeft(CanExecutePrefix.Length);
        ...
        private void VerifyDependencies()
        {
            ...
            propertyNames.ForEach(VerifyDependency);
        }
