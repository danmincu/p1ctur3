...
namespace Telekad.Mapping
{
    ...
    /// </summary>
    public struct QuadKey : IRangeExtended<Coordinate>
    {
        ...
        public bool Contains(Coordinate point)
        {
            ...
            QuadKey qk = QuadKey.ConvertCoordinateToQuadKey(point, this.Level);
        ...
        /// <summary>
        /// Converts the coordinate to a quad key.
        /// </summary>
        public static QuadKey ConvertCoordinateToQuadKey(Coordinate coordinate, int level)
        {
            ArgumentValidation.CheckArgumentForNull(coordinate, "coordinate");

            return Mapping.TileSystem.CoordinateToQuadKey(coordinate, level);
        }
        ...
        {
            return Mapping.TileSystem.QuadKeyToQuadrangle(quadKey);
        }
        ...
        public object Value
        {
            get { return TileSystem.QuadKeyToQuadrangle(this).Centre; }
        }
    }
}
