...
namespace Telekad.Mapping
{
    ...
    public static class TileSystem
    {
        ...
        private static class MercatorProjection
        {
            ...
            {
                double num = Math.Sin(latLong.Y * 0.017453292519943295);
        ...
        public static QuadKey CoordinateToQuadKey(Coordinate location, int levelOfDetail)
        {
            ...
            if (!IsValidLevelOfDetail(levelOfDetail))
                throw new MappingException("Invalid level of detail");
        ...
        public static Quadrangle QuadKeyToQuadrangle(QuadKey quadKey)
        {
            ...
            if (!IsValidQuadKey(quadKey.Key))
                throw new MappingException("Invalid QuadKey");
        ...
        {
            if (!IsValidLevelOfDetail(levelOfDetail))
                throw new MappingException("levelOfDetail");
        ...
        private static QuadKey TileToQuadKey(Tile tile, int levelOfDetail)
        {
            ...
            if (!IsValidQuadKey(quadKey.ToString()))
                throw new MappingException("Generated invalid quad key");
        ...
        private static Tile QuadKeyToTile(QuadKey quadKey, out int levelOfDetail)
        {
            ...
            for (int i = levelOfDetail; i > 0; i--)
            {
                ...
                switch (quadKey.Key[levelOfDetail - i])
                {
                    ...
                    default:
                        throw new MappingException("Invalid QuadKey digit sequence.");
                }
            }
        ...
        public static Tile CoordinateToTile(Coordinate location, int levelOfDetail)
        {
            ...
            // present in the image and pixel (0,0) the the top left pixel in the image.
            var pixel = TileSystem.CoordinateToPixel(location, levelOfDetail);
        ...
        private static double ClipToRange(double value, double min, double max)
        {
        ...
        public static Coordinate ClipToRange(double latitude, double longitude)
        {
            return new Coordinate(
                    ClipToRange(latitude, MinLocation.Latitude,MaxLocation.Latitude),
                    ClipToRange(longitude, MinLocation.Longitude,MaxLocation.Longitude));
        }
