...
namespace ShutterTale.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MediaTest"/> instance.
		/// </summary>	
		public MediaTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Media objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Media CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Media mock = MediaTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Media mock)
        {
            MediaTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Media mock)
        {
