...
namespace ShutterTale.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MediaAudioTest"/> instance.
		/// </summary>	
		public MediaAudioTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  MediaAudio objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public MediaAudio CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            MediaAudio mock = MediaAudioTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, MediaAudio mock)
        {
            MediaAudioTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(MediaAudio mock)
        {
