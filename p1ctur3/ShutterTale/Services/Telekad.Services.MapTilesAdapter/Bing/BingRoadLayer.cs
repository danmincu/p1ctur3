...
{
    public class BingRoadLayer : BingBaseMapLayer
    {
        private readonly string urlFormat = "http://t{0}.tiles.virtualearth.net/tiles/r{1}.png?g=244&token={2}";
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings", MessageId = "2#")]
        public BingRoadLayer(IConfigurationElement configuration)
            : base(configuration)
        {
